    ...
    return (
      <div className='p-10 flex flex-col'>
        <div className='flex w-full items-center justify-center'>
          <h1 className='text-2xl font-bold text-gray-900'>Listado de los Proyectos</h1>
        </div>
    ...
    <>
      <AccordionStyled>
        ...
        <AccordionDetailsStyled>
          ...
          <div> <span className="font-bold">Liderado por:</span> {proyecto.lider.correo}</div>
          <div className='flex'>
...
const InscripcionProyecto = ({ idProyecto, estado, inscripciones }) => {
  ...
  return (
    <>
      {estadoInscripcion !== '' ? (
        <span>El usuario ya está inscrito en este proyecto; su estado es {estadoInscripcion}</span>
      ) : (
        <ButtonLoading
