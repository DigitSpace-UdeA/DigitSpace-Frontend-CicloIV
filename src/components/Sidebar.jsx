...
const Logo = () => {
  return (
    <div className='py-3 w-full flex flex-col items-center justify-center'>
      ...
      <span className='my-2 text-xl font-bold text-center'>Gestión de Proyectos DigitSpace</span>
    </div>
  );
};
  ...
  return (
    <li>
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? 'sidebar-route text-white bg-red-700'
            : 'sidebar-route text-red-900 hover:text-white hover:bg-red-400'
        }
      >
        <div className='flex items-center'>
          <i className={icon} />
